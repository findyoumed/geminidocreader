# #7 DOCUMENT
# Document는 사용자가 업로드한 문서에 대해 질문하고 답변을 받을 수 있는 인공지능 기반 시스템입니다.

# #7.0 Introduction
# 이 섹션에서는 Document에 필요한 기본 설정과 라이브러리를 소개합니다.
...
from langchain_community.vectorstores.faiss import (
    FAISS,
)  # 벡터 데이터베이스를 사용하기 위한 도구입니다.
from langchain_huggingface import (
    HuggingFaceEmbeddings,
)  # 텍스트를 벡터로 변환하는 도구입니다.
from langchain_core.prompts import (
    ChatPromptTemplate,
)  # AI와의 대화를 위한 템플릿을 만드는 도구입니다.
